...
const Process = () => {
  ...
  return (
    <>
      <section
        id="ourProcess"
        className="bg-white pt-20 sm:mt-[500px] sm:py-48 md:mt-[350px] md:py-20  lg:mt-16 lg:py-24"
      >
        <div className="mt-20">
          <SectionTitle
            title="Our Process"
          ...
          <div className="flex flex-wrap ">
            <div data-aos="fade-up" data-aos-anchor-placement="top-center">
              <div className="mt-5 grid sm:gap-y-5 md:mx-10 md:grid-cols-1  lg:grid-cols-1 xl:grid-cols-1 2xl:grid-cols-2">
                <div className="mb-5 px-5 md:px-0">
                  <img
                    className={`w-full md:mt-0   lg:object-contain ${selectLangauge == "Chinese" ? "max-h-[600px]" : "max-h-[700px]"} 2xl:min-h-min `}
                ...
                <div className="px-5">
                  ...
                  <div className="mt-10 flex justify-center px-5 md:px-0 xl:mt-5 xl:flex xl:justify-start">
                    <button
                      onClick={() => router.push("/#enquiry")}
                      className="cursor-none rounded border-0 bg-[#014aad] px-8 py-2 text-lg text-white hover:bg-[#014aad] focus:outline-none"
                    >
